...
def test_auction_item_can_be_created():
    data = {
        ...
        'starting_price': Currency(10.00),
        'start_date': datetime.now(),
        'end_date': datetime.now(),
    }
    auction_item = AuctionItem(id=data['id'], title=data['title'], description=data['description'],
                               starting_price=data['starting_price'], start_date=data['start_date'], end_date=data['end_date'])
    ...
    assert auction_item.current_price == data['starting_price']
